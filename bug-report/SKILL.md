...
- `scripts/generate_report.py` — Main script: reads config.json + ado_bugs.json (+ optional ado_comments_analysis.json) → generates HTML report
- `scripts/fetch_comments.py` — Fetches ADO work item comments and detects priority/category discrepancies
- `ado_bugs.json` — Raw ADO query output (refreshed each run)
- `ado_comments_analysis.json` — Comment discrepancy analysis (generated by scripts/fetch_comments.py)
