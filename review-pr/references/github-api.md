...
6. **Verify line numbers against the source file, not the diff**: See `review-checklist.md` § "Line Number Verification" for full guidance. Always run `grep -n` on the downloaded source file before posting inline comments.
